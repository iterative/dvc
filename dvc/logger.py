...
def setup_handlers():
    if not logger.handlers:
        ...
        logger.handlers = [logging.FileHandler(temp_log_file), logging.FileHandler(temp_log_file)]
...
class MockHandlers(object):
    ...
    def __enter__(self):
        self._logger.handlers = [logging.FileHandler('tmp{}.log'.format(i)) for i in range(self._num)]
        return self
