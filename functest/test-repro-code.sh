...
function test_partial() {
	...
	dvc run -d code/code1.sh -d data/foo -o data/foo1 cp data/foo data/foo1
	dvc run -d code/code2.sh -d data/foo1 -o data/foo2 cp data/foo1 data/foo2
	dvc run -d code/code3.sh -d data/foo2 -o data/foo3 cp data/foo2 data/foo3
