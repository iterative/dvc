        ...
        param(
            ...
            },
            {
                "committed": {
                    "renamed": m.unordered(
                        (join("dir", ""), join("dir2", "")),
                        (join("dir", "bar"), join("dir2", "bar")),
                        (join("dir", "foo"), join("dir2", "foo")),
                        ("file", "file2"),
                    )
                },
                "uncommitted": {
                    "modified": [join("dir2", "")],
                    "renamed": [(join("dir2", "foo"), join("dir2", "foobar"))],
                },
            },
        ),
        param(
